...
export default {
  ...
  async getPendingAndArchivedUsers() {
    return http.get('user/pending-archived-users').then(res => {
      return res.data
    })
  },
  async acceptUser(email) {
    return http.post(`user/${email}/accept-user`).then(res => {
      return res.data
    })
  },
  async declineUser(email) {
    return http.post(`user/${email}/decline-user`).then(res => {
      return res.data
    })
  },
  getUser() {
  ...
  getProfileInfo(id) {
    return http.get(`student/profile-info/${id}`).then(res => {
      return res.data
    })
  },
  updateUser(user) {
